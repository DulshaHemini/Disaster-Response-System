...
// FIXED: Added 'Landslide Rescue' and 'Multi-hazard Rescue' to ENUM
 $sql = "CREATE TABLE IF NOT EXISTS relief_team ( 
    relief_team_id INT PRIMARY KEY, 
    team_name VARCHAR(100) NOT NULL, 
    email VARCHAR(100), 
    contact_no VARCHAR(15), 
    specialization ENUM( 'Medical', 'Flood Rescue', 'Food Distribution', 'Transport', 'Animal Rescue', 'Emergency Response', 'Landslide Rescue', 'Multi-hazard Rescue'),
...
// FIXED: Added 'urgent' to priority_level.
...
// FIXED: Added 'medical', 'hygiene', 'clothing' to resource_type
 $sql = "CREATE TABLE IF NOT EXISTS resource(
    ...
    resource_type ENUM('food','water','medicine','medical','shelter','clothes','clothing','rescue','electricity','communication','hygiene') NOT NULL,
    resource_count INT,
    description TEXT,
...
// FIXED: Added 'Pending' and 'In_Progress' to status ENUM
...
$sql = "CREATE TABLE IF NOT EXISTS assignments(
    ...
    description TEXT,
    status ENUM('Assigned', 'Doing', 'Done', 'Allocated', 'Received', 'Pending', 'In_Progress') DEFAULT 'Assigned',
