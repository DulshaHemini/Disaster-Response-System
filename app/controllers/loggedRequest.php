    ...
    * {
    ...
    <body>
        ...
        <h1>Request Submission Form</h1>
            <div class="box">
                <form method="POST" id="helpNeeder" onsubmit="return validateForm()">

                <label>Name</label>
                <input type="text" name="username" id="username" value="<?php echo $name; ?>" placeholder="Enter Your Name" required>

                <label>Request Name</label>
                <input type="text" name="request_name" id="request_name" reqiured>
                ...
                <input type="number" name="affected_people" pattern="[0-9]+" value="1" min="1">
                ...
                <input type="number" name="resource_count" value="1" min="1"  required>

                <label>Contact Number </label>
                <input type="text" name="contact_number" id="contact_number" pattern="^07[0-9]{8}$" placeholder="07XXXXXXXX" maxlength="10" required>
                ...
                <input type="text" name="home_number" id="home_number" placeholder="NO:103/c">
                ...
                <input type="text" name="district" id="district" list="districtlist" placeholder="Type or select district" required>
