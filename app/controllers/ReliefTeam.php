...
// SIMULATE LOGGED IN RELIEF TEAM (Change this to actual logged in user ID later)
if (!isset($_SESSION['user_id'])) {
    $_SESSION['user_id'] = 10; // e.g. Galle Navy Rescue from our mock data
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && isset($_POST['task_id'])) {
    ...
    header("Location: ReliefTeamController.php");
    exit();
}
...
$affectedCount = 2; // (Placeholder, would require a more complex query joining affected_people)
